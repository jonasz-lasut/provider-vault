...
type SecretBackendInitParameters struct {
	...
	BindpassSecretRef v2.LocalSecretKeySelector `json:"bindpassSecretRef" tf:"-"`
	...
	// Client certificate to provide to the LDAP server, must be x509 PEM encoded.
	ClientTLSCertSecretRef *v2.LocalSecretKeySelector `json:"clientTlsCertSecretRef,omitempty" tf:"-"`
