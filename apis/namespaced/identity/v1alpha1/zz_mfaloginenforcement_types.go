...
type MfaLoginEnforcementInitParameters struct {
	...
	MfaMethodIdsRefs []v2.NamespacedReference `json:"mfaMethodIdsRefs,omitempty" tf:"-"`

	// Selector for a list of MfaDuo in identity to populate mfaMethodIds.
	// +kubebuilder:validation:Optional
	MfaMethodIdsSelector *v2.NamespacedSelector `json:"mfaMethodIdsSelector,omitempty" tf:"-"`
